...
import background from "../../image/background/doctorsRegister.jpg";
    ...
    >
      <div className="container h-100">
        <div className="row align-items-center h-100 justify-content-center">
          <div className="col-10  col-md-8 col-lg-5 bg-light  border border-dark rounded px-5 py-2 py-sm-3 py-lg-4">
            <Link to="/" className="text-start text-danger">
              <h6>Home</h6>
            </Link>
            <h3 className="mb-2">REGISTER - DOCTOR</h3>
            <form className="text-start">
              ...
              <div className="form-group mb-2">
                <label className="" for="university">
                  University
                </label>
                <input
                  type="text"
